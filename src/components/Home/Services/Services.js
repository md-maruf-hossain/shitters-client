...
const Services = () => {
  ...
  return (
    <div className="mt-14 flex flex-col items-center">
      ...
      <Link to="/services" className="text-lg font-semibold mt-10 hover:text-orange-500 hover:underline flex items-center">
        See More <HiOutlineArrowNarrowRight className="ml-1" />
      </Link>
    </div>
  );
};
